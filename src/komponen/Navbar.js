...
const Navbar = () => {
    ...
    <a className="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right w3-padding-large w3-hover-white w3-large w3-light-blue" onClick={myFunction} title="Toggle Navigation Menu">Menu</a>
